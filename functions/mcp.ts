...
import { WebStandardStreamableHTTPServerTransport } from "@modelcontextprotocol/sdk/server/web.js";
import { z } from "zod";
...
function buildServer(): McpServer {
  const server = new McpServer({ name: "kpp-tax-calculator", version: "1.0.0" });
...
export const onRequest: (context: { request: Request }) => Promise<Response> = async (context) => {
